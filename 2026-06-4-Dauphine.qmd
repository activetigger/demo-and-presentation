...
subtitle: "Annoter un corpus textuel et entrainer des classifieurs"
...
Une V1 + communauté d'utilisateurs instance dev. du CREST
...
## Quand utilise-t-on ActiveTigger ?

- **Phase initiale** : explorer les données
- **Phase intermédiaire** : stabiliser un codebook (schémas/labels) et discuter des cas limites
- **Phase avancée** : annoter un grand corpus avec un classifieur bien entraîné
...
- Projet déjà créé
- Comptes accessibles ici sur une instance démo : [https://tinyurl.com/f6cvxvya](https://tinyurl.com/f6cvxvya)
